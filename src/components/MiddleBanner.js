...
function MiddleBanner(props) {
    const { classes } = props;
    return (
        <div className={classes.root} className={classes.popular} className={classes.typo}>
            <Toolbar className={classes.popular}>
                <Grid container className={classes.root} className={classes.popular} justify="center">
